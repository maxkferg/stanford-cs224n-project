...
class learning_phase(object):
	...
	def __enter__(self):
		self.learning_phase_place_holder = _backend.learning_phase()
		_backend.set_learning_phase(self.value)

	def __exit__(self, *args):
		_backend.set_learning_phase(self.learning_phase_place_holder)
