...
def embedding_rnn_seq2seq(encoder_inputs,
  ...
  with variable_scope.variable_scope(scope or "embedding_rnn_seq2seq") as scope:
    ...
    # Save the encoder state so that we can use it for document comparison
    print("Capturing encoder state in embedding_rnn_seq2seq")
    save_tensors["encoder_context"] = encoder_state
