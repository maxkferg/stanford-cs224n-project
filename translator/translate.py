...
# Note:
# This file was heavily adapted by Max Ferguson as part of the CS224N Project
# The adaptions allow the trained encoder to be used for paraphrase detection
# The main additions are contained within the `compare` function
#
# ==============================================================================
...
tf.app.flags.DEFINE_boolean("compare", False, "Set to True for interactive sentence comparison.")
tf.app.flags.DEFINE_boolean("summary", False, "Set to True for graph summary.")
...
def summary():
  """
  Provide a simple summary of trained model performance
  Uses out five sentence comparison example as a performance metric
  """
  comparison_task()
...
def decode():
  with tf.Session() as sess:
    ...
    while sentence:
      ...
      output_context = model.step_context(sess, encoder_inputs, decoder_inputs,
...
def interactive_comparison():
  ...
  with tf.Session() as sess:
    ...
    while sentence:
      ...
      # Get the output context vector
      output_context = model.step_context(sess, encoder_inputs, decoder_inputs,target_weights, bucket_id)
